package com.dgtedr.backend.project.logging;
...
public class ResourceLoggingAspect {
    ...
    private static final Logger LOG = LoggerFactory.getLogger("Project resource");

    @Pointcut("execution(* com.dgtedr.backend.project.resource..*(..))")
