...
export const verticalMenuItems = [ 
    ...
    new Menu (421, 'Welcome', '/amp/onboard', null, 'wechat', null, false, 42),
    new Menu (426, 'Contact Details', '/amp/onboard/contact-info', null, 'address-card', null, false, 42),
    new Menu (422, 'Transaction Types', '/amp/onboard/transaction-types', null, 'credit-card-alt', null, false, 42),
    new Menu (423, 'Accepted Currencies', '/amp/onboard/accepted-currencies', null, 'bitcoin', null, false, 42),
    new Menu (424, 'Primary Shipping Address', '/amp/onboard/shipping-address', null, 'ship', null, false, 42),
    new Menu (43, 'User Profile', '/amp/user-profile', null, 'file-o', null, false, 0),
    new Menu (425, 'Thank you', '/amp/onboard/thank-you', null, 'thumbs-up', null, false, 42),
